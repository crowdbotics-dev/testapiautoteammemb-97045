...
## Project Structure
    ...
    ├── testapiautoteammemb_97045  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_97045`
...
2. Clone this repo and `cd testapiautoteammemb_97045`
